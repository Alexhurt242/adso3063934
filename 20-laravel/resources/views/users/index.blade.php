...
@section('content')
    ...
    <div class="join mb-auto">
        <a class="btn btn-outline btn-success join-item bg-[#fff] " href="{{ url('users/create') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#16a59e" viewBox="0 0 256 256">
                <path
        ...
        <a class="btn btn-outline btn-success join-item bg-[#fff] " href="{{ url('export/users/pdf') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#16a59e" viewBox="0 0 256 256">
                <path
        ...
        <a class="btn btn-outline btn-success join-item bg-[#fff] " href="{{ url('export/users/excel') }}">
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#16a59e" viewBox="0 0 256 256">
                <path
    ...
    <dialog id="modal_delete" class="modal">
        <div class="modal-box">
            ...
            <div role="alert" class="alert alert-error alert-outline">You want to delete: <strong class="fullname"></strong></span>
            </div>
            <div class="flex gap-4 justify-end mt-4">
                <button class="btn btn-default btn-sm text-[red] bg-[#ffffff] border-red-600 btn-confirm">Confirm</button>
                <form method="dialog">
                <button class="btn btn-default btn-sm bg-[#ffffff]">Cancel</button>
                </form>
            </div>
        </div>
        <form method="dialog" class="modal-backdrop">
