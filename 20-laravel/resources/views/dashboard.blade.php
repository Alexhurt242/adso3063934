...
@section('content')
    ...
    <div class="flex flex-wrap gap-4 items-center justify-center">
        ...
        <div class="card text-white bg[#0006] w-96 shadow-sm">
            <figure class="h-64">
                <img src="{{ asset('images/user.png') }}" alt="Shoes" />
            </figure>
            <div class="card-body">
                ...
                <ul class="list bg[#0003] backdrop-blur-sm rounded-box shadow-md">
                    ...
                    <li class="list-row">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#fafafa"
                                viewBox="0 0 256 256">
                                <path
                ...
                <div class="card-actions justify-end">
                    <a class="btn btn-outline hover:bg-[#fff6] hover:backdrop-blur-sm hover:text-white mt-3"
                        href="{{ url('users') }}">
                        Enter
        ...
        <div class="card text-white bg[#0006] w-96 shadow-sm">
            <figure class="h-64">
                <img src="{{ asset('images/pet.png') }}" alt="Shoes" />
            </figure>
            <div class="card-body">
        ...
        <div class="card text-white bg[#0006] w-96 shadow-sm">
            <figure class="h-64">
                <img src="{{ asset('images/adopted.png') }}" alt="Shoes" />
            </figure>
            <div class="card-body">
